...
movies = pickle.load(open(r'C:\miniproject\contentbased filtering\movies.pkl','rb'))
similarity = pickle.load(open(r'C:\miniproject\contentbased filtering\similarity.pkl','rb'))
